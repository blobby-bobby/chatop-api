...
import fr.ishtamar.api.auth.AuthRequest;
import fr.ishtamar.api.auth.CreateUserRequest;
import fr.ishtamar.api.auth.UpdateUserRequest;
import fr.ishtamar.api.exceptionhandler.BadCredentialsException;
import fr.ishtamar.api.user.UserDto;
import fr.ishtamar.api.user.UserInfo;
import fr.ishtamar.api.exceptionhandler.EntityNotFoundException;
import fr.ishtamar.api.user.UserMapper;
